...
const Constants = {
  ...
  PARTNER_PROJECT_DETAILS_LOADING_START:
    "PARTNER_PROJECT_DETAILS_LOADING_START",
  ...
  CLUSTER_DISAGGREGATIONS_LOADING_START:
    "CLUSTER_DISAGGREGATIONS_LOADING_START",
  ...
  ADD_PROGRAMME_DOCUMENTS: "ADD_PROGRAMME_DOCUMENTS",
  ...
  UPDATE_PD_REPORT_INDICATOR_TOTAL: "UPDATE_PD_REPORT_INDICATOR_TOTAL",
  ...
  CLUSTER_INDICATOR_REPORTS_LOADING_START:
    "CLUSTER_INDICATOR_REPORTS_LOADING_START",
  CLUSTER_INDICATOR_REPORTS_LOADING_STOP:
    "CLUSTER_INDICATOR_REPORTS_LOADING_STOP",
  ...
  SET_INDICATORS_BY_CLUSTER_OBJECTIVE_ID:
    "SET_INDICATORS_BY_CLUSTER_OBJECTIVE_ID",
  ...
  SET_INDICATORS_BY_CLUSTER_ACTIVITY_ID:
    "SET_INDICATORS_BY_CLUSTER_ACTIVITY_ID",
  ...
  SET_INDICATORS_BY_PARTNER_ACTIVITY_ID:
    "SET_INDICATORS_BY_PARTNER_ACTIVITY_ID",
  ...
  OPERATIONAL_PRESENCE_DATA_LOADING_START:
    "OPERATIONAL_PRESENCE_DATA_LOADING_START",
  OPERATIONAL_PRESENCE_DATA_LOADING_STOP:
    "OPERATIONAL_PRESENCE_DATA_LOADING_STOP",
  SET_OPERATIONAL_PRESENCE_DATA: "SET_OPERATIONAL_PRESENCE_DATA",

  OPERATIONAL_PRESENCE_MAP_LOADING_START:
    "OPERATIONAL_PRESENCE_MAP_LOADING_START",
  OPERATIONAL_PRESENCE_MAP_LOADING_STOP:
    "OPERATIONAL_PRESENCE_MAP_LOADING_STOP",
  SET_OPERATIONAL_PRESENCE_MAP: "SET_OPERATIONAL_PRESENCE_MAP",

  ANALYSIS_INDICATORS_DATA_LOADING_START:
    "ANALYSIS_INDICATORS_DATA_LOADING_START",
  ANALYSIS_INDICATORS_DATA_LOADING_STOP:
    "ANALYSIS_INDICATORS_DATA_LOADING_STOP",
  SET_ANALYSIS_INDICATORS_DATA: "SET_ANALYSIS_INDICATORS_DATA",
  ANALYSIS_INDICATOR_DATA_LOADING_START:
    "ANALYSIS_INDICATOR_DATA_LOADING_START",
